...
$locale_info["LOCALE_SCURRENCY"]="\200";
...
function format_datetime_custom($time,$format)
{
	...
	$subst["M"]=$time[1];
	$subst["yyyy"]=sprintf("%04d",$time[0]);
	$subst["yy"]=sprintf("%02d",$time[0]%100);
	$subst["y"]=$time[0]%10;
	$subst["gg"]="";
