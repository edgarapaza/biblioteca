...
<br><br><input class=button type=submit value="<?php echo "Guardar"?>" name=submit1>
<input class=button type=button onClick='window.close();return false;' value="<?php echo "Cerrar ventana"?>">
</div>
</form>
